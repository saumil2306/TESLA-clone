...
<body>
    ...
    name="registration" style="width: 70%;position: relative;left: 14vw;right: 14vw;font-size: 20px;" onsubmit="return formValidation();">
        ...
        <div class="col-12">
            ...
            <input type="radio" class="btn-check" name="options" id="option4" value="blue" autocomplete="off"
                style="float: right;">
            <label class="btn btn-secondary" for="option4"
                style="float: right;margin-right: 10px;background-color: rgb(13, 13, 71);"></label>

            <input type="radio" class="btn-check" name="options" id="option5" value="grey" autocomplete="off"
                style="float: right;">
        ...
        <div class="col-12">
            ...
            <input type="radio" class="btn-check" name="wheel" id="wheel1" value="Tempest" autocomplete="off"
                style="float: right;">
            ...
            <input type="radio" class="btn-check" name="wheel" id="wheel2" value="Arachnid" autocomplete="off"
                style="float: right;">
